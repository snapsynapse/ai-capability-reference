...
| Plan | Price | Notes |
|------|-------|-------|
| Free | $0 | Unlimited basic, 5-10 Pro queries/day |
| Pro | $20/mo | Unlimited Pro searches, multiple models |
| Max | $200/mo | Highest limits, priority access |
| Enterprise Pro | $40/user/mo | Team features |
...
| Plan | Available | Limits | Notes |
|------|-----------|--------|-------|
| Free | ✅ | All modes | Full access |
| Pro | ✅ | All modes | Full access |
| Max | ✅ | All modes | Full access |
...
> "Focus modes let you search specific sources—Academic, YouTube, Reddit, etc. **Available on all plans including free.**"
...
| Plan | Available | Limits | Notes |
|------|-----------|--------|-------|
| Free | ❌ | — | Default model only |
| Pro | ✅ | Full | GPT-5, Claude, Gemini, etc. |
| Max | ✅ | Full | All models |
...
> "Pro users can **choose which AI model answers**—GPT-5, Claude, Gemini, and others. Free users get Perplexity's default model only."

### Sources

- [Perplexity Pro Features](https://www.perplexity.ai/pro)
...
| Max | ✅ | Full | All voice features |

### Platforms

| Platform | Available | Notes |
|----------|-----------|-------|
| Windows | ✅ | Via Comet (Mar 2026) |
| macOS | ✅ | Via Comet (Mar 2026) |
| Linux | ❌ |  |
| iOS | ✅ | Perplexity app |
| Android | ✅ | Perplexity app + Hey Perplexity hotword |
| Chrome | ❌ |  |
| web | ✅ | Via Perplexity Computer (Mar 2026) |
| terminal | ❌ |  |
| API | ❌ | No voice API |
