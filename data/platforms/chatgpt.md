...
> "Voice input is available on **all ChatGPT plans including free**. The free tier gets basic voice transcription. Go and above unlock **Advanced Voice Mode** with natural, real-time conversations."
...
| Free | ❌ | — | Not available |
| Go | ❌ | — | Not available |
| Plus | ✅ | 10/month | Extended research tasks |
| Pro | ✅ | 125/month | Higher limits |
...
> "Deep Research lets ChatGPT spend minutes researching a topic thoroughly. It's **Plus and above only**—Plus gets 10 deep research tasks per month, Pro gets 125."
